...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      carouselItems={[
        ...
        },
        {
          ...
          imageAlt: "Clinic view 1",
        },
        {
          id: "3",
          imageSrc: "http://img.b2bpic.net/free-photo/examination-bed-dry-needling-clinic_107420-65816.jpg",
          imageAlt: "Clinic view 2",
        },
        {
          id: "4",
          ...
          imageAlt: "Clinic view 3",
        },
        {
          id: "5",
          imageSrc: "http://img.b2bpic.net/free-photo/female-doctor-diagnosing-melanoma-body-female-patient_23-2149365771.jpg",
          imageAlt: "Clinic view 4",
        },
        {
          id: "6",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-interior-room-design-concept_23-2148786439.jpg",
          imageAlt: "Clinic view 5",
        },
      ]}
    />
  </div>
      ...
      features={[
        {
          ...
          tag: "Especialidade",
          imageSrc: "http://img.b2bpic.net/free-photo/dna-genetic-biotechnology-science-gold-neon-graphic_53876-167299.jpg",
        },
        {
          id: "f2",
          title: "Fisioterapia para Gestantes",
          description: "Preparação física e alívio de dores durante a gestação.",
          tag: "Gestação",
          imageSrc: "http://img.b2bpic.net/free-photo/abstract-acrylic-texture_23-2148132191.jpg",
        },
        {
          id: "f3",
          title: "Pós-parto",
          description: "Recuperação funcional e bem-estar no pós-parto imediato e tardio.",
          tag: "Recuperação",
          imageSrc: "http://img.b2bpic.net/free-photo/mother-spending-time-with-her-beloved-child_23-2149505182.jpg",
        },
        {
          id: "f4",
          title: "Saúde Íntima Feminina",
          description: "Cuidado integral focado na funcionalidade e qualidade de vida.",
          tag: "Bem-estar",
          imageSrc: "http://img.b2bpic.net/free-photo/arrangement-paper-made-woman-crying_23-2148857185.jpg",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Foco total na sua história.",
          tag: "Destaque",
        ...
        },
        {
          ...
          description: "Tecnologia e aconchego.",
          tag: "Destaque",
        ...
        },
        {
          ...
          tag: "Destaque",
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-physiotherapist-with-table_23-2149173470.jpg",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "t2",
          name: "Monike Cristina",
          imageSrc: "http://img.b2bpic.net/free-photo/fashion-girl-posing-photo-studio_1157-33957.jpg",
        },
        {
          id: "t3",
          name: "Ana Silva",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-s-studio-portrait-ideal-skin-blonde-straight-hair_633478-1288.jpg",
        },
        {
          id: "t4",
          name: "Beatriz Souza",
      ...
      metrics={[
        {
          ...
          value: "100%",
          title: "Atendimento",
          description: "Personalizado e atencioso",
          icon: Heart,
        },
        {
          id: "m2",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "O que é fisioterapia pélvica?",
          content: "É uma especialidade que trata disfunções musculares e nervosas do assoalho pélvico feminino.",
        },
        {
          id: "q2",
          title: "Preciso de encaminhamento médico?",
          content: "Não necessariamente, mas é recomendado para uma avaliação interdisciplinar.",
        },
        {
          id: "q3",
          title: "Como agendar?",
          content: "Você pode agendar diretamente pelo botão de WhatsApp em nosso site.",
        },
      ]}
